...
O objetivo desse pacote `{somaCredor}` é disponibilizar o script que ajuda a somar todos os créditos
...
ou existir algum dos padrões acima, verifique  o resultado de forma manual. 
